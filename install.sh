#!/usr/bin/env sh
# Universal installer for darkmirror. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/darkmirror.git"
echo "Installing darkmirror ..."
