"""Native cognis-connect emit for darkmirror — forward findings to any platform.

Maps darkmirror's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    darkmirror ... --format json | darkmirror-emit --to stix
    darkmirror-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
